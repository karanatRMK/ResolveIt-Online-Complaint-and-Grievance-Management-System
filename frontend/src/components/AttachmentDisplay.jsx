...
const AttachmentDisplay = ({ complaintId }) => {
  ...
  const handleDownload = async (attachment) => {
    try {
      ...
      const downloadUrl = `http://localhost:8081/complaints/${complaintId}/attachments/${attachment.id}`;
  ...
  const handlePreview = (attachment) => {
    ...
    const token = localStorage.getItem('token');
    const previewUrl = `http://localhost:8081/complaints/${complaintId}/attachments/${attachment.id}`;
                      ...
                      {isImage && (
                        <div className="attachment-preview mb-3">
                          <div 
                            ...
                            onClick={() => handlePreview(attachment)}
                            style={{ 
                              backgroundImage: `url(http://localhost:8081/complaints/${complaintId}/attachments/${attachment.id})`,
                              cursor: 'pointer'
                            }}
                          >
